"""
Django settings for Truly_info project.
...
SECRET_KEY = '25ksb0&+4$no6m(mx-ev^z%ypuh8jvtdsht+osia9_09pvc_h+'
...
WSGI_APPLICATION = 'Truly_info.wsgi.application'
